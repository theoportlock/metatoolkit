...
DEPRECATION: Building 'metatoolkit' using the legacy setup.py bdist wheel mechanism, which will be removed in a future version. pip 25.3
metatoolkit to analyse crc cohorts from atlas and CMD
metatoolkit pointheatmap sort out
Better testing and test datasets
